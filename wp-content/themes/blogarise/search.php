            ...
            <div class="col-lg-<?php echo ( !is_active_sidebar( 'sidebar-1' ) ? '12' :'8' ); ?>">
                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    $url = blogarise_get_freatured_image_url($post->ID, 'blogarise-medium');
                        if($url) { ?>
                        <div id="post-<?php the_ID(); ?>" <?php post_class('bs-posts-sec bs-posts-modul-6 bs-blog-post list-blog'); ?>>
                            <?php } else { ?>
                        <div id="post-<?php the_ID(); ?>" <?php post_class('bs-posts-sec bs-posts-modul-6 bs-blog-post list-blog d-flex'); ?>>
