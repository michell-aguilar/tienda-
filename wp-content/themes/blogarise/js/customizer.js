...
( function( $ ) {
	...
	wp.customize( 'header_textcolor', function( value ) {
		if(value() == 'blank'){
			myCustomizer.control('blogarise_title_font_size').container.hide();
		}else{
			myCustomizer.control('blogarise_title_font_size').container.show();
		}
		value.bind( function( to ) {
			if ( 'blank' === to ) {
	...
	wp.customize( 'blogarise_title_font_size', function( value ) {
